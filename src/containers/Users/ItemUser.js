  ...
  <Item>
    ...
    <Item.Content verticalAlign='middle'>
      ...
      <Item.Description>
        ...
        <Rating icon='star' defaultRating={user.rating} maxRating={5} disabled />
      </Item.Description>
      <Item.Extra><Label.Group tag>{user.skills.map(skill => <Label content={skill} key={skill} color='blue' />)}</Label.Group></Item.Extra>
    </Item.Content>
  </Item>
)
