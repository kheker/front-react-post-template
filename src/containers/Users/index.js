  ...
  render() {
    ...
    return (
      <Grid container stackable>
        ...
        <Grid.Row>
          <Grid.Column>
            <Segment>Buscador</Segment>
          </Grid.Column>
        </Grid.Row>
        <Grid.Row>
          <Grid.Column width={4}>
            <Segment>Filtros de busqueda</Segment>
          </Grid.Column>
          <Grid.Column width={12}>
            {Object.keys(error).length ? (
              <Message
                negative
                content="Algo va mal intentalo de nuevo o mas tarde"
              />
            ) : (
              <Segment loading={isLoading}>
                {users.length === 0 ? (
                  <Message success content="No hay usuarios diponibles" />
                ) : (
                  <Item.Group>
